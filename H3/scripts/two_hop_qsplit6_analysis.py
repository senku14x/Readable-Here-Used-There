...
L.append(f"| P6 current base ≥ B − 0.10; plane rebuilt ≥ 0.5 by block 62? | {Pp['P6_cb_share_ok']} / {Pp['P6_plane_rebuilt']} (≥ 0.5 somewhere in the band: {T['current_base']['plane_rebuilt_ge_0.5_anywhere_in_band']}) | `{CB_ROW}` {f3(sh(CB_ROW))}, B {f3(B)}, weighted re-entry fraction at L62 {T['current_base']['reentry_fraction_L62']:.2f}, first block ≥ 0.5: L{T['current_base']['first_block_weighted_ge_0.5']} |")
